...
assert lastModuleIndex != 0  && lastModuleIndex > deployerExtensionIndex && lastModuleIndex < uploadingToSnapshotIndex &&
        lastModuleIndex < installingArtifactIndex && lastModuleIndex < deployingArtifactIndex
