...
int skipDeployerExtenstionBecauseOfError = 0
for(String line : lines ) {
    ...
    if(line.contains("The Maven Deployer Extension will not be called based on previous errors")) {
        skipDeployerExtenstionBecauseOfError = lines.indexOf(line)
    }
}
